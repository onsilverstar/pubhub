...
<!-- 	Just some stuff you need -->
	...
	%>
		...
		<form action="ViewBookDetails" class="form-horizontal">
		  ...
		  <div class="form-group">
		    <label for="removetag" class="col-sm-4 control-label">Remove Tag</label>
		    <div class="col-sm-5">
		      <input type="radio" class="form-control" id="removetag" name="removetag" value="remove"/>
		    </div>
		  </div>
		  <div class="form-group">
